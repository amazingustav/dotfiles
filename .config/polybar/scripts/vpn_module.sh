...
# The relay_set command assumes <country_code> <cdaity_code> will follow as arguments. See below.
VPN_CONNECT="sudo openvpn --config ~/development/client.ovpn --auth-retry --daemon"
VPN_DISCONNECT="pgrep openvpn | xargs sudo kill -9"
